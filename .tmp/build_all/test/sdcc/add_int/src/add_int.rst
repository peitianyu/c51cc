      ...
      000049 02 00 B7         [24]  170 	ljmp	_main
                                    ...
                                    175 	.area CSEG    (CODE)
                                    176 ;------------------------------------------------------------
                                    177 ;Allocation info for local variables in function 'add_int'
                                    178 ;------------------------------------------------------------
                                    179 ;b             Allocated with name '_add_int_PARM_2'
                                    180 ;a             Allocated to registers r6 r7 
                                    181 ;------------------------------------------------------------
                                    182 ;	add_int.c:1: int add_int(int a, int b) { return a + b; }
                                    183 ;	-----------------------------------------
                                    184 ;	 function add_int
                                    185 ;	-----------------------------------------
      0000A8                        186 _add_int:
                           000007   187 	ar7 = 0x07
                           000006   188 	ar6 = 0x06
                           ...
                           000001   193 	ar1 = 0x01
                           000000   194 	ar0 = 0x00
      0000A8 AE 82            [24]  195 	mov	r6, dpl
      0000AA AF 83            [24]  196 	mov	r7, dph
      0000AC E5 08            [12]  197 	mov	a,_add_int_PARM_2
      0000AE 2E               [12]  198 	add	a, r6
      0000AF F5 82            [12]  199 	mov	dpl,a
      0000B1 E5 09            [12]  200 	mov	a,(_add_int_PARM_2 + 1)
      0000B3 3F               [12]  201 	addc	a, r7
      0000B4 F5 83            [12]  202 	mov	dph,a
      0000B6 22               [24]  203 	ret
                                    204 ;------------------------------------------------------------
                                    205 ;Allocation info for local variables in function 'main'
                                    206 ;------------------------------------------------------------
                                    207 ;x             Allocated to registers 
                                    208 ;y             Allocated to registers 
                                    209 ;z             Allocated to registers 
                                    210 ;------------------------------------------------------------
                                    211 ;	add_int.c:3: int main() {
                                    212 ;	-----------------------------------------
                                    213 ;	 function main
                                    214 ;	-----------------------------------------
      0000B7                        215 _main:
                                    216 ;	add_int.c:6: int z = add_int(x, y);
      0000B7 75 08 0A         [24]  217 	mov	_add_int_PARM_2,#0x0a
      0000BA 75 09 00         [24]  218 	mov	(_add_int_PARM_2 + 1),#0x00
      0000BD 90 00 05         [24]  219 	mov	dptr,#0x0005
                                    220 ;	add_int.c:7: return z; // expect 15
                                    221 ;	add_int.c:8: }
      0000C0 02 00 A8         [24]  222 	ljmp	_add_int
                                    223 	.area CSEG    (CODE)
                                    224 	.area CONST   (CODE)
                                    225 	.area XINIT   (CODE)
