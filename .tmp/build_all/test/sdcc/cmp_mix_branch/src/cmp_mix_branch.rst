      ...
      000000 02 00 4C         [24]   95 	ljmp	__sdcc_gsinit_startup
      ...
      0000A5 02 00 49         [24]  168 	ljmp	__sdcc_program_startup
                                    169 ;--------------------------------------------------------
                                    170 ; Home
                                    171 ;--------------------------------------------------------
                                    172 	.area HOME    (CODE)
      ...
      000049 02 00 F4         [24]  175 	ljmp	_main
                                    ...
                                    180 	.area CSEG    (CODE)
                                    181 ;------------------------------------------------------------
                                    182 ;Allocation info for local variables in function 'b_lt'
                                    183 ;------------------------------------------------------------
                                    184 ;i             Allocated to registers r7 
                                    185 ;------------------------------------------------------------
                                    186 ;	cmp_mix_branch.c:4: u8 b_lt(u8 i) {
                                    187 ;	-----------------------------------------
                                    188 ;	 function b_lt
                                    189 ;	-----------------------------------------
      0000A8                        190 _b_lt:
                           ...
                           000001   197 	ar1 = 0x01
                           000000   198 	ar0 = 0x00
      0000A8 AF 82            [24]  199 	mov	r7, dpl
                                    200 ;	cmp_mix_branch.c:5: if ((u16)i < 8) return 1;
      0000AA BF 08 00         [24]  201 	cjne	r7,#0x08,00111$
      0000AD                        202 00111$:
      0000AD 50 04            [24]  203 	jnc	00102$
      0000AF 75 82 01         [24]  204 	mov	dpl, #0x01
      0000B2 22               [24]  205 	ret
      0000B3                        206 00102$:
                                    207 ;	cmp_mix_branch.c:6: return 0;
      0000B3 75 82 00         [24]  208 	mov	dpl, #0x00
                                    209 ;	cmp_mix_branch.c:7: }
      0000B6 22               [24]  210 	ret
                                    211 ;------------------------------------------------------------
                                    212 ;Allocation info for local variables in function 'b_le'
                                    213 ;------------------------------------------------------------
                                    214 ;i             Allocated to registers r7 
                                    215 ;------------------------------------------------------------
                                    216 ;	cmp_mix_branch.c:9: u8 b_le(u8 i) {
                                    217 ;	-----------------------------------------
                                    218 ;	 function b_le
                                    219 ;	-----------------------------------------
      0000B7                        220 _b_le:
                                    221 ;	cmp_mix_branch.c:10: if ((u16)i <= 8) return 1;
      0000B7 E5 82            [12]  222 	mov	a,dpl
      0000B9 24 F7            [12]  223 	add	a,#0xff - 0x08
      0000BB 40 04            [24]  224 	jc	00102$
      0000BD 75 82 01         [24]  225 	mov	dpl, #0x01
      0000C0 22               [24]  226 	ret
      0000C1                        227 00102$:
                                    228 ;	cmp_mix_branch.c:11: return 0;
      0000C1 75 82 00         [24]  229 	mov	dpl, #0x00
                                    230 ;	cmp_mix_branch.c:12: }
      0000C4 22               [24]  231 	ret
                                    232 ;------------------------------------------------------------
                                    233 ;Allocation info for local variables in function 'b_eq'
                                    234 ;------------------------------------------------------------
                                    235 ;i             Allocated to registers r7 
                                    236 ;------------------------------------------------------------
                                    237 ;	cmp_mix_branch.c:14: u8 b_eq(u8 i) {
                                    238 ;	-----------------------------------------
                                    239 ;	 function b_eq
                                    240 ;	-----------------------------------------
      0000C5                        241 _b_eq:
      0000C5 AF 82            [24]  242 	mov	r7, dpl
                                    243 ;	cmp_mix_branch.c:15: if ((u16)i == 3) return 1;
      0000C7 BF 03 04         [24]  244 	cjne	r7,#0x03,00102$
      0000CA 75 82 01         [24]  245 	mov	dpl, #0x01
      0000CD 22               [24]  246 	ret
      0000CE                        247 00102$:
                                    248 ;	cmp_mix_branch.c:16: return 0;
      0000CE 75 82 00         [24]  249 	mov	dpl, #0x00
                                    250 ;	cmp_mix_branch.c:17: }
      0000D1 22               [24]  251 	ret
                                    252 ;------------------------------------------------------------
                                    253 ;Allocation info for local variables in function 'b_ne'
                                    254 ;------------------------------------------------------------
                                    255 ;i             Allocated to registers r7 
                                    256 ;------------------------------------------------------------
                                    257 ;	cmp_mix_branch.c:19: u8 b_ne(u8 i) {
                                    258 ;	-----------------------------------------
                                    259 ;	 function b_ne
                                    260 ;	-----------------------------------------
      0000D2                        261 _b_ne:
      0000D2 AF 82            [24]  262 	mov	r7, dpl
                                    263 ;	cmp_mix_branch.c:20: if ((u16)i != 3) return 1;
      0000D4 BF 03 02         [24]  264 	cjne	r7,#0x03,00111$
      0000D7 80 04            [24]  265 	sjmp	00102$
      0000D9                        266 00111$:
      0000D9 75 82 01         [24]  267 	mov	dpl, #0x01
      0000DC 22               [24]  268 	ret
      0000DD                        269 00102$:
                                    270 ;	cmp_mix_branch.c:21: return 0;
      0000DD 75 82 00         [24]  271 	mov	dpl, #0x00
                                    272 ;	cmp_mix_branch.c:22: }
      0000E0 22               [24]  273 	ret
                                    274 ;------------------------------------------------------------
                                    275 ;Allocation info for local variables in function 'loop_lt'
                                    276 ;------------------------------------------------------------
                                    277 ;start         Allocated to registers 
                                    278 ;i             Allocated to registers r7 
                                    279 ;------------------------------------------------------------
                                    280 ;	cmp_mix_branch.c:24: u8 loop_lt(u8 start) {
                                    281 ;	-----------------------------------------
                                    282 ;	 function loop_lt
                                    283 ;	-----------------------------------------
      0000E1                        284 _loop_lt:
      0000E1 AF 82            [24]  285 	mov	r7, dpl
                                    286 ;	cmp_mix_branch.c:26: while ((u16)i < 8) {
      0000E3                        287 00101$:
      0000E3 8F 06            [24]  288 	mov	ar6,r7
      0000E5 BE 08 00         [24]  289 	cjne	r6,#0x08,00118$
      0000E8                        290 00118$:
      0000E8 50 07            [24]  291 	jnc	00103$
                                    292 ;	cmp_mix_branch.c:27: i = i + 1;
      0000EA 8F 06            [24]  293 	mov	ar6,r7
      0000EC EE               [12]  294 	mov	a,r6
      0000ED 04               [12]  295 	inc	a
      0000EE FF               [12]  296 	mov	r7,a
      0000EF 80 F2            [24]  297 	sjmp	00101$
      0000F1                        298 00103$:
                                    299 ;	cmp_mix_branch.c:29: return i;
      0000F1 8F 82            [24]  300 	mov	dpl, r7
                                    301 ;	cmp_mix_branch.c:30: }
      0000F3 22               [24]  302 	ret
                                    303 ;------------------------------------------------------------
                                    304 ;Allocation info for local variables in function 'main'
                                    305 ;------------------------------------------------------------
                                    306 ;	cmp_mix_branch.c:32: int main()
                                    307 ;	-----------------------------------------
                                    308 ;	 function main
                                    309 ;	-----------------------------------------
      0000F4                        310 _main:
                                    311 ;	cmp_mix_branch.c:34: return 0;
      0000F4 90 00 00         [24]  312 	mov	dptr,#0x0000
                                    313 ;	cmp_mix_branch.c:35: }
      0000F7 22               [24]  314 	ret
                                    315 	.area CSEG    (CODE)
                                    316 	.area CONST   (CODE)
                                    317 	.area XINIT   (CODE)
