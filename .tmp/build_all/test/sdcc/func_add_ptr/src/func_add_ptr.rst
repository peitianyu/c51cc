                                      ...
                                      4 ;--------------------------------------------------------
                                      5 	.module func_add_ptr
                                      6 	
                                      7 	.optsdcc -mmcs51 --model-small
                                      8 ;--------------------------------------------------------
                                      9 ; Public variables in this module
                                     10 ;--------------------------------------------------------
                                     11 	.globl _add_ptr_PARM_2
                                     12 	.globl _main
                                     13 	.globl _add_ptr
                                     14 ;--------------------------------------------------------
      ...
      000049 02 00 B0         [24]  170 	ljmp	_main
                                    ...
                                    175 	.area CSEG    (CODE)
                                    176 ;------------------------------------------------------------
                                    177 ;Allocation info for local variables in function 'add_ptr'
                                    178 ;------------------------------------------------------------
                                    179 ;x             Allocated with name '_add_ptr_PARM_2'
                                    180 ;p             Allocated to registers r5 r6 r7 
                                    181 ;------------------------------------------------------------
                                    182 ;	func_add_ptr.c:1: char add_ptr(char *p, char x) {
                                    183 ;	-----------------------------------------
                                    184 ;	 function add_ptr
                                    185 ;	-----------------------------------------
      0000A8                        186 _add_ptr:
                           000007   187 	ar7 = 0x07
                           000006   188 	ar6 = 0x06
                           ...
                           000001   193 	ar1 = 0x01
                           000000   194 	ar0 = 0x00
                                    195 ;	func_add_ptr.c:2: return *p + x;
      0000A8 12 00 B4         [24]  196 	lcall	__gptrget
      0000AB 25 08            [12]  197 	add	a,_add_ptr_PARM_2
      0000AD F5 82            [12]  198 	mov	dpl,a
                                    199 ;	func_add_ptr.c:3: }
      0000AF 22               [24]  200 	ret
                                    201 ;------------------------------------------------------------
                                    202 ;Allocation info for local variables in function 'main'
                                    203 ;------------------------------------------------------------
                                    204 ;	func_add_ptr.c:5: int main()
                                    205 ;	-----------------------------------------
                                    206 ;	 function main
                                    207 ;	-----------------------------------------
      0000B0                        208 _main:
                                    209 ;	func_add_ptr.c:7: return 0;
      0000B0 90 00 00         [24]  210 	mov	dptr,#0x0000
                                    211 ;	func_add_ptr.c:8: }
      0000B3 22               [24]  212 	ret
                                    213 	.area CSEG    (CODE)
                                    214 	.area CONST   (CODE)
                                    215 	.area XINIT   (CODE)
