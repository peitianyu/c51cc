                                      ...
                                      4 ;--------------------------------------------------------
                                      5 	.module func_add_op
                                      6 	
                                      7 	.optsdcc -mmcs51 --model-small
                                      8 ;--------------------------------------------------------
                                      9 ; Public variables in this module
                                     10 ;--------------------------------------------------------
                                     11 	.globl _add_op_PARM_2
                                     12 	.globl _main
                                     13 	.globl _add_op
                                     14 ;--------------------------------------------------------
      ...
      000049 02 00 B0         [24]  170 	ljmp	_main
                                    ...
                                    175 	.area CSEG    (CODE)
                                    176 ;------------------------------------------------------------
                                    177 ;Allocation info for local variables in function 'add_op'
                                    178 ;------------------------------------------------------------
                                    179 ;b             Allocated with name '_add_op_PARM_2'
                                    180 ;a             Allocated to registers r7 
                                    181 ;------------------------------------------------------------
                                    182 ;	func_add_op.c:1: char add_op(char a, char b) {
                                    183 ;	-----------------------------------------
                                    184 ;	 function add_op
                                    185 ;	-----------------------------------------
      0000A8                        186 _add_op:
      ...
      0000A8 AF 82            [24]  195 	mov	r7, dpl
                                    196 ;	func_add_op.c:2: return a + b;
      0000AA E5 08            [12]  197 	mov	a,_add_op_PARM_2
      0000AC 2F               [12]  198 	add	a, r7
      0000AD F5 82            [12]  199 	mov	dpl,a
                                    200 ;	func_add_op.c:3: }
      0000AF 22               [24]  201 	ret
                                    202 ;------------------------------------------------------------
                                    203 ;Allocation info for local variables in function 'main'
                                    204 ;------------------------------------------------------------
                                    205 ;	func_add_op.c:5: int main()
                                    206 ;	-----------------------------------------
                                    207 ;	 function main
                                    208 ;	-----------------------------------------
      0000B0                        209 _main:
                                    210 ;	func_add_op.c:7: return 0;
      0000B0 90 00 00         [24]  211 	mov	dptr,#0x0000
                                    212 ;	func_add_op.c:8: }
      0000B3 22               [24]  213 	ret
                                    214 	.area CSEG    (CODE)
                                    215 	.area CONST   (CODE)
                                    216 	.area XINIT   (CODE)
